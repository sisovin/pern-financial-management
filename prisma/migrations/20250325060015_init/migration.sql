...
-- CreateIndex
CREATE UNIQUE INDEX "admin_data_userId_key" ON "admin_data"("userId");

-- CreateIndex
CREATE INDEX "admin_data_userId_idx" ON "admin_data"("userId");
...
-- AddForeignKey
ALTER TABLE "admin_data" ADD CONSTRAINT "admin_data_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
